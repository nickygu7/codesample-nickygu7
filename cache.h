/**
 * @file cache.h
 * @brief Prototypes for Cache helper functions
 */
...
typedef struct {
    ...
    unsigned long dirty_bytes;     // number of dirty bytes in cache at end of simulation
...
/* External variables defined in cache.c */
